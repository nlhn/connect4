...
impl OttoBot {
    ...
    pub fn best_move(&self, board: &mut TootOttoBoard, player: char) -> (usize, char){
    ...
    fn minimax(&self, board: &mut TootOttoBoard, depth: u32,alpha: i32, beta: i32, player: char) -> (i32, usize, char) {
        let mut alpha = alpha;
        let mut beta = beta;
        let mut best_move = 2;
